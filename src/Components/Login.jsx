...
//                         </div>
//                         <span className='text-[14px] cursor-pointer' onClick={() => window.location.href = '/forgot-password'}>Forget Password?</span>
//                     </div>
...
//                     <span className='text-[14px] pt-2'>Don't have an account? <span className='font-semibold cursor-pointer' onClick={() => window.location.href = '/register'}>Register</span></span>
//                 </form>
//             </div>
//         </div>
//     );
